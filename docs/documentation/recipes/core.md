...
Both these will be provided by Qlik when receiving license details of the QIX Engine.
...
Also note that Mira must be configured to run in Kubernetes mode. This does not happen automatically.
