...
Name | Type | Description
---- | ---- | -----------
`qReturn` | boolean | &lt;true or false&gt;<br><div class=note>The field is in AND mode if **qReturn** is set to true. </div>
...
Name | Type | Description
---- | ---- | -----------
`qReturn` | boolean | &lt;true/false&gt;<br><div class=note>The operation is successful if **Return** is set to true. </div>
