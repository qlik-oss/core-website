...
---- | ---- | --------- | -----------
`qRequestId` | integer | Yes | _None available_
...
The engine copies the app into an app entity that was previously created by the repository. See the [Qlik Sense Repository Service API](/Subsystems/RepositoryServiceAPI/Content/RepositoryServiceAPI/RepositoryServiceAPI-Introduction.htm) for more information.
...
Name | Type | Mandatory | Description
---- | ---- | --------- | -----------
`qdocId` | string | Yes | _None available_

##### Returns

Name | Type | Description
---- | ---- | -----------
`qdoc` | object | _None available_
...
Name | Type | Mandatory | Description
---- | ---- | --------- | -----------
`qattr` | undefined | Yes | _None available_
...
This method is deprecated (not recommended for use). Use the _GetBaseBNF method_ instead. 
...
Name | Type | Description
---- | ---- | -----------
`qConfig` | object | _None available_
...
Name | Type | Description
---- | ---- | -----------
`qFolder` | string | _None available_
...
Lists the streams.
This method is deprecated (not recommended to use). Use general purpose endpoint in [QRS API: GET qrs/stream/](/Subsystems/RepositoryServiceAPI/Content/RepositoryServiceAPI/RepositoryServiceAPI-Get.htm) instead.
...
This operation is possible only in Qlik Sense Enterprise. It is not recommended to use this method to import an app. Use the Qlik Sense Repository Service API instead. In addition to importing the app, the Qlik Sense Repository Service API migrates the app if needed.
...
This method is deprecated (not recommended for use). Use the _EngineVersion method_ instead. 
...
Name | Type | Mandatory | Description
---- | ---- | --------- | -----------
`qAppId` | string | Yes | _None available_
`qName` | string | Yes | _None available_
`qStreamId` | string | Yes | _None available_
...
---- | ---- | --------- | -----------
`qdocId` | string | Yes | _None available_
`qpublish` | undefined | Yes | _None available_
...
Returns the Qlik Sense version number.
This method is deprecated (not recommended to use). Use the _EngineVersion method_ instead. 
