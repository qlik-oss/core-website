...
_API specification for version 12.96.0, generated on 2017-11-14T11:53:52.445Z._
...
The expression is correct if the parameters _qErrorMsg_ and _qBadFieldNames_ are empty. 
...
Creates a variable.
This method is deprecated (not recommended to use). Use _CreateVariableEx method_ instead. 
...
To set some properties to the variable, use the _SetProperties method_. In a published app, only transient variables can be created. See _CreateSessionVariable method_. 
...
`qReturn` | object | _None available_
...
Name | Type | Description
---- | ---- | -----------
`qReturn` | boolean | &lt;true or false&gt;<br><div class=note>The operation is successful if **qReturn** is set to true. </div><br>If the data load has successfully finished, no matter how the indexing behaves, _true_ is returned. This happens even if there is a timeout, a memory limit is reached, or any other error occurs during the indexing.
...
Name | Type | Mandatory | Description
---- | ---- | --------- | -----------
`qParams` | object | No | _None available_

##### Returns

Name | Type | Description
---- | ---- | -----------
`qResult` | object | _None available_
...
Name | Type | Mandatory | Description
---- | ---- | --------- | -----------
`qOptions` | object | No | _None available_

##### Returns

Name | Type | Description
---- | ---- | -----------
`qDownloadInfo` | object | _None available_
...
Name | Type | Mandatory | Description
---- | ---- | --------- | -----------
`qOptions` | object | Yes | _None available_

##### Returns

Name | Type | Description
---- | ---- | -----------
`qList` | array | _None available_
...
`qOwner` | string | No | Owner of the database.<br>If _qOwner_ is not set then _qDatabase_ must be set.
`qTable` | string | Yes | Name of the table.
`qConditions` | object | No | _None available_
...
`qRowCount` | integer | _None available_
...
Name | Type | Description
---- | ---- | -----------
`qReturn` | string | &lt;List of script variables&gt; ## Returns<br>{ "jsonrpc": "2.0", "id": 4, "result": { "qReturn": &lt;List of script variables&gt; }}
...
Name | Type | Mandatory | Description
---- | ---- | --------- | -----------
`qReadableName` | string | Yes | _None available_

##### Returns

Name | Type | Description
---- | ---- | -----------
`qName` | string | _None available_
...
This method is deprecated (not recommended to use). Use _GetLibraryContent method_ instead. 
...
`qNullSize` | object | Yes | _None available_
...
This method is deprecated (not recommended to use). Use _GetVariableById method_ or _GetVariableByName method_ instead. 
...
This operation is possible only in Qlik Sense Enterprise. An app can only be published once and cannot be published to more than one stream.
...
Removes a variable.
This method is deprecated (not recommended to use). Use _DestroyVariableById method_ or _DestroyVariableByName method_ instead. 
...
Name | Type | Mandatory | Description
---- | ---- | --------- | -----------
`qFieldName` | string | Yes | _None available_
...
This method is deprecated (not recommended to use). Use _SearchResults method_ instead. 
...
Name | Type | Description
---- | ---- | -----------
`qReturn` | boolean | &lt;true/false&gt;<br><div class=note>The engine returns true if the vector has been updated.</div>
