...
Set the region of the S3 bucket in the environment variable: `CORE_S3_FILE_CONNECTOR_BUCKET_REGION`, list of regions can be found here: https://docs.aws.amazon.com/general/latest/gr/rande.html
