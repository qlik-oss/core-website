...
| --------- | ------------------------------ |
| text      | The original string.|
| from_str  | A string which may occur one or more times within the input string .|
...
| delimiter | A character within the input  that divides the string into component parts.|
...
| ---------- | ------------------------------------------------------ |
| text       | The original string.|
| delimiter1 | Specifies the first delimiting character (or string) to search for in .|
