...
| EnableGrpcFileStreamConnector | `0` (disabled) or `1` (enabled) | Enables gRPC File Connector feature in the Qlik Associative Engine. For more details see this [remote files tutorial](../../tutorials/data-loading/remote-files.md). | `0` (disabled) |
