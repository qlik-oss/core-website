...
| Name | Type | Description |
| ---- | ---- | ----------- |
| `qReturn` | boolean | &lt;true or false&gt;<br>he field is in AND mode if **qReturn** is set to true.  |
...
Gets the properties of a field.<br>The property _OneAndOnlyOne_ is set to true if one and only value has been selected in the field prior setting the property. 
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| `qReturn` | boolean | &lt;true/false&gt;<br>he operation is successful if **Return** is set to true.  |
...
| Name | Type | Mandatory | Description |
| ---- | ---- | --------- | ----------- |
| `qMatch` | string | Yes | String to search for.<br>an contain wild cards or numeric search criteria. |
| `qSoftLock` | boolean | No | Set to true to ignore locks; in that case, locked fields can be selected.<br>he default value is false. |
...
Selects all alternatives values in a specific field.<br>n a field that contains at least one selected value, the values that are neither selected nor excluded are alternatives values.
...
| Name | Type | Mandatory | Description |
| ---- | ---- | --------- | ----------- |
| `qAndMode` | boolean | Yes | Specifies if the AND mode applies to the field.<br>et this parameter to true to enter the AND mode. |
