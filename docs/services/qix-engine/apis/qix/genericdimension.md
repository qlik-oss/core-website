...
Adds the generic dimension to the list of approved objects<br>his operation is possible only in Qlik Sense Enterprise.
...
Returns the definition of a dimension.<br>The definition of the dimension is returned.
...
Shows the properties of an object.<br>eturns the identifier and the definition of the dimension.<br>f the member delta is set to true in the request object, only the delta is retrieved.
...
Removes the generic dimension from the list of approved objects<br>his operation is possible only in Qlik Sense Enterprise.
